  ...
  return (
    <nav style={{ position: "fixed", zIndex: "100" }}>
      <Div className="desktop-nav">
        <Div d="flex" w="100vw" h="17.5vh" align="center" bg="white">
          <Image
            w="auto"
            h={{ md: "7.5vh", xl: "15vh" }}
            p="1.25vh 1vw"
          ...
          <Div
            ...
            align="center"
          >
            <Div d="flex" align="center" w="15vw" className="nav-text">
              <Icon name="Message" size="20px" color="primaryGreen" />
              <Text
                p="0 0 0 0.75rem"
                tag="p"
                textSize="body"
              ...
              >
                7/24 Hizmete Açığız <br />
                <Anchor href="tel:+9005323007152" textColor="primaryBlue">
                  +90 0532 300 71 52
                </Anchor>
              </Text>
            </Div>
            <Div d="flex" w="auto" h="10vh" p="1rem" align="center">
